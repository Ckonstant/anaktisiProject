...
public class MainGUI extends javax.swing.JFrame {
 ...
 private static final String CSV_FILE_PATH = "C:\\all_lyrics.csv";
    private static final String INDEX_DIRECTORY_PATH = "C:\\path";
    /**
...
String selectedOption = jComboBox1.getSelectedItem().toString();
    ...
    public static void main(String args[]) throws IOException, CsvValidationException {
        ...
        Directory indexDirectory = FSDirectory.open(Paths.get(INDEX_DIRECTORY_PATH));
        Analyzer analyzer = new WhitespaceAnalyzer();
        IndexWriterConfig config = new IndexWriterConfig(analyzer);
        IndexWriter indexWriter = new IndexWriter(indexDirectory, config);
        
        CSVReader csvReader = new CSVReader(new FileReader(CSV_FILE_PATH));
        String[] headers = csvReader.readNext(); // Get headers from the first row
        String[] line;
            ...
            for (int i = 0; i < line.length; i++) {
               ...
               // System.out.println(line[1]);
                if (fieldName.equals("lyrics")) {
                    // Handle multi-line lyrics with quoted commas
    ...
    TopDocs topDocs = indexSearcher.search(query, start + hitsPerPage);
